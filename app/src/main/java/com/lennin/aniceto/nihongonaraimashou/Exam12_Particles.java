...
public class Exam12_Particles extends Fragment {

    private TextView countLabel, questionLabel, ei;
    private EditText answertext;
    private Button answerBtn;

    private String rightAnswer, lessonnum = "Lesson12", examcategory = "Particle";
    ...
    String quizData [][] = {
            ...
            //{"Question", "Answer"}
            {"スポーツ___なか___バスケットボール___いちばん すき です。たのしい です から。","の／で／が"},
            {"あおいくつ___あかいくつ___ずっと やすい です。","は／より"},
            {"かぞく___なか___はは___いちばん うた___じょうず です。","の／で／が／が"},
            {"はる___あき___どちら___すき です か。 どちら も すき です。","と／と／が"},
            {"くるま___バス___どちら___はやい です か。","と／と／が"},
            {"けいたい___パソコン___アイパッド と なに___いちばん  たかい です か。","と／と／が"},
            {"クラス___なか___だれ___いちばん あたま が いい です か。","の／で／が"},
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_exam12_particles, container, false);
