...
public class Exam5 extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new Exam5_Vocab(), "Vocabulary");
        adapter.addFragment(new Exam5_Particles(), "Particle");
        adapter.addFragment(new Exam5_Interrogatives(), "Interrogative");
