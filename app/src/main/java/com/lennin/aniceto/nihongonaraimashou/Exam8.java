...
public class Exam8 extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new Exam8_Vocab(), "Vocabulary");
        adapter.addFragment(new Exam8_Particles(), "Particle");
        adapter.addFragment(new Exam8_Interrogatives(), "Interrogative");
