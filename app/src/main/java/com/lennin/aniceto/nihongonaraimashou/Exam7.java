...
public class Exam7 extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new Exam7_Vocab(), "Vocabulary");
        adapter.addFragment(new Exam7_Particles(), "Particle");
        adapter.addFragment(new Exam7_Interrogatives(), "Interrogative");
