...
public class Exam3 extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new Exam3_Vocab(), "Vocabulary");
        adapter.addFragment(new Exam3_Particles(), "Particle");
        adapter.addFragment(new Exam3_Interrogatives(), "Interrogative");
