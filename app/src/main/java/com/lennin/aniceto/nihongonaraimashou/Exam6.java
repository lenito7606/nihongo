...
public class Exam6 extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new Exam6_Vocab(), "Vocabulary");
        adapter.addFragment(new Exam6_Particles(), "Particle");
        adapter.addFragment(new Exam6_Interrogatives(), "Interrogative");
