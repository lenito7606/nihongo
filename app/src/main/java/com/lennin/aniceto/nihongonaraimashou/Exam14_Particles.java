...
public class Exam14_Particles extends Fragment {

    private TextView countLabel, questionLabel, ei;
    private EditText answertext;
    private Button answerBtn;

    private String rightAnswer, lessonnum = "Lesson14", examcategory = "Particle";
    ...
    String quizData [][] = {
            ...
            //{"Question", "Answer"}
            {"ここ は きんえんです___そこ___たばこ___すって ください。","から／で／を"},
            {"おくさん___じゅうよんねんかん けっこんしています。","と"},
            {"きょう、いいてんきです___こうえん___さんぽ___いきましょう。","から／へ／に"},
            {"カリナさん は いまき___した___え___はな を かいています。","の／で／の"},
            {"あなた の けいたい___いす___おいて ください。","を／に"},
            {"ちいさん___いま本___よんでいます","は／を"},
            {"今日あめ___ふっています","が"},
            {"たいしかん___みぎ___まがって ください。","を／へ"},
            {"ねつ___あります___くすり___のんで　ください","が／から／を"},
            {"いまテレビ___みて ください","を"},
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_exam14_particles, container, false);
