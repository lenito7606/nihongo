...
public class Exam4 extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFragment(new Exam4_Vocab(), "Vocabulary");
        adapter.addFragment(new Exam4_Particles(), "Particle");
        adapter.addFragment(new Exam4_Interrogatives(), "Interrogative");
